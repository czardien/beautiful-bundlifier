...
from src import bundlify
from lib.config import Config
from lib.hypervisor import HypervisorNaive
...
def test_naive(tmp_file, capsys):
    ...
    bundlify.bundlify(tmp_file.name, hypervisor, Config.CSV_HEADERS)
